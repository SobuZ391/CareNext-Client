...
const ManageMedicines = () => {
    ...
    const fetchCategories = async () => {
      try {
        const res = await axios.get(
          "https://y-plum-nine.vercel.app/categories"
        );
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const categoryImageRes = await axios.post(
        image_hosting_api,
        formDataCategoryImage,
        {
          headers: {
            "content-type": "multipart/form-data",
          },
      ...
      if (imageRes.data.success && categoryImageRes.data.success) {
        ...
        const medicineRes = await axios.post(
          "https://y-plum-nine.vercel.app/products",
          newMedicine
        );
  ...
  return (
    <div className="container mx-auto px-4">
      <Helmet>
        <title>CareNext Pharamacy | Dashboard | Manage Medicine</title>
      </Helmet>
      <h1 className="text-3xl font-bold text-center border-y-2 p-2 w-72 mx-auto">
        Manage Medicines
      </h1>
      <div className="border-2 rounded-xl">
        <h1 className="text-2xl font-bold p-2 m-2 border-b-2 w-72 mx-auto">
          Medicine Add Section
        </h1>
        <button
          className="btn p-4 mx-auto w-full border-2 btn-accent"
          onClick={openModal}
        >
